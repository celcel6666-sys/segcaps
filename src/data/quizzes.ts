...
export const QUIZZES_DATA: Record<string, DeptQuizData> = {
  ...
  AUTOMOTIVE: {
    introDialogue: [
      { text: "오! 자동차 엔진 소리가 우렁차지? 여기는 미래자동차과 실습장이다! 🛠️", expression: 'default', choices: ["우와, 엔진 조립이랑 튜닝을 하는 곳이네!", "도기 멋있다!"] },
      { text: "엔진부터 전기 자동차 센서까지, 모빌리티의 미래를 여는 핵심 퀴즈를 풀어보자!", expression: 'default', choices: ["스마트 드라이브, 도전! 🚗"] }
    ],
    quizzes: [
      {
        id: 1,
  ...
  ARCHITECTURE: {
    ...
    outroDialogueFail: [
      { text: "설계 도면 수치 조절에 오차가 발생하여 건물이 버티지 못했어. 다시 계산기를 들고 도전해 보길 바래!", expression: 'default', choices: ["도면을 다시 수정해서 도전할게!"] }
    ]
  },
  MILITARY: {
    introDialogue: [
      { text: "충성! 강인한 체력과 투철한 안보 정신으로 무장한 디지털정보부사관과 연병장에 온 것을 환영한다! 🪖", expression: 'default', choices: ["우와! 절도 있는 군사 훈련 모습이 멋집니다!", "정예 육군 간부의 기백이 느껴지네요!"] },
      { text: "국가 안보와 지휘관 리더십을 갖추기 위해 필수적인 기초 군사 지식과 상식 평가를 시작하겠다!", expression: 'default', choices: ["훈련 개시! 🎖️"] }
    ],
    quizzes: [
      {
        id: 1,
  ...
  SEMICONDUCTOR: {
    introDialogue: [
      { text: "안녕 칩! 여긴 첨부 산업의 쌀로 불리는 반도체 소자를 설계하고 실리콘 공정을 실습하는 하이테크 교실이다 칩! 💻", expression: 'default', choices: ["나노 소자와 컴퓨터 칩을 만드는 스마트한 곳이네!", "실리콘 방진복들이 신기해!"] },
      { text: "초정밀 첨부 과학인 반도체 소자와 공정에 관한 유익하고 대중적인 상식 퀴즈를 풀어보자 칩!", expression: 'default', choices: ["나노 나노 칩, 도전! ⚡"] }
    ],
    quizzes: [
      {
        id: 1,
    ...
    outroDialogueSuccess: [
      { text: "나노 브레인급 논리 추론력을 보여주었다 칩! 첨단 실리콘 반도체 뱃지를 전수하겠다 칩! 🏆", expression: 'default', choices: ["반도체 소자 설계, 정말 흥미로워!"] }
    ],
    outroDialogueFail: [
      { text: "미세 공정 정밀도 수치에 노이즈가 유입되어 불량 칩이 생성되었다 칩. 공정 라인을 리셋하고 재도전해 달라 칩!", expression: 'default', choices: ["공정 회로 라인을 보정해서 다시 해볼게 칩!"] }
    ]
  }
};
